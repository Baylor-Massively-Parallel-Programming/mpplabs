...
\item Now that you are in.  We need to fix our default environment to allow us to support the latest version of cuda.
	...
	\end{enumerate}
\item Type \verb1mkdir code1 then \verb1cd code1.  You will now clone the lab from github by typing \\ \verb1https://github.com/Baylor-Massively-Parallel-Programming/mpplabs.git1
